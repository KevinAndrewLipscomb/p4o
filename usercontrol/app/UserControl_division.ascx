<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_division.ascx.cs" Inherits="UserControl_division.TWebUserControl_division"%>
    ...
    <td valign="top">
          ...
          <td valign="top">
            <font class="compact">
              ...
              <ASP:TextBox id="TextBox_id" runat="server" columns="3" maxlength="3" cssclass="compact"></ASP:TextBox><ASP:Button id="Button_lookup" runat="server" causesvalidation="False" text="LOOKUP" onclick="Button_lookup_Click"></ASP:Button>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new Division</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
              </table>
      <table>
        <tr>
          ...
          <td>
            <div style="width:0px;white-space:nowrap;"><ASP:DropDownList id="DropDownList_spec" runat="server" visible="False" autopostback="True" onselectedindexchanged="DropDownList_code_SelectedIndexChanged"></ASP:DropDownList></div>
          </td>
        </tr>
      </table>
            </font>
        ...
        <tr>
          <td><font class="compact">Bureau:</font></td>
          <td>
            <font class="compact">
              <ASP:DropDownList id="DropDownList_bureau" runat="server" cssclass="compact" enabled="False"></ASP:DropDownList>
            </font>
          </td>
          <td>
            <ASP:RequiredFieldValidator id="RequiredFieldValidator_bureau" runat="server" errormessage="Please select a Bureau." font-bold="True" controltovalidate="DropDownList_bureau" display="Dynamic">!ERR!</ASP:RequiredFieldValidator>
          </td>
        </tr>
      </table>
    </td>
