<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_squad.ascx.cs" Inherits="UserControl_squad.TWebUserControl_squad"%>
    ...
    <td valign="top">
          ...
          <td valign="top">
            <font class="compact">
              ...
              <ASP:TextBox id="TextBox_id" runat="server" columns="3" maxlength="3" cssclass="compact"></ASP:TextBox><ASP:Button id="Button_lookup" runat="server" causesvalidation="False" text="LOOKUP" onclick="Button_lookup_Click"></ASP:Button>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new Squad</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
              </table>
      <table>
        ...
        <tr>
          ...
          <td>
            <ASP:RequiredFieldValidator id="RequiredFieldValidator_unit" runat="server" errormessage="Please select a Unit." font-bold="True" controltovalidate="DropDownList_unit" display="Dynamic">!ERR!</ASP:RequiredFieldValidator>
          </td>
        </tr>
      </table>
    </td>
