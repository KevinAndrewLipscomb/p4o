...
namespace UserControl_role_privilege_mapping
{
    ...
    public partial class TWebUserControl_role_privilege_mapping: ki_web_ui.usercontrol_class
    {
        ...
        {
            p.biz_role_privilege_map.Save(kix.Units.kix.Safe(GridView_control.Rows[e.RowIndex].Cells[Units.UserControl_role_privilege_mapping.CI_PRIVILEGE_ID].Text, kix.safe_hint_type.NUM), kix.Units.kix.Safe(GridView_control.Rows[e.RowIndex].Cells[Units.UserControl_role_privilege_mapping.CI_ROLE_ID].Text, kix.safe_hint_type.NUM), false);
            Bind();
        }
        ...
        private void GridView_control_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType != DataControlRowType.EmptyDataRow)
            {
                ...
                // + e.row.Cells[CI_PRIVILEGE_NAME].Text + '?' + kix.Units.kix.NEW_LINE
                // + kix.Units.kix.NEW_LINE
                ...
                else
                {
                    ...
                    e.Row.Cells[Units.UserControl_role_privilege_mapping.CI_UNMAP].Text = kix.Units.kix.EMPTY;
                }
        ...
        {
            p.biz_role_privilege_map.Save(kix.Units.kix.Safe(DropDownList_privilege.SelectedValue, kix.safe_hint_type.NUM), kix.Units.kix.Safe(DropDownList_role.SelectedValue, kix.safe_hint_type.NUM), true);
            Bind();
        }
