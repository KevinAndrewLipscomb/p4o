...
namespace UserControl_unit
{
    public partial class TWebUserControl_unit: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            InitializeComponent();
            base.OnInit(e);
            if (Session["UserControl_unit.p"] != null)
            {
            ...
            else
            {
                ...
                p.be_ok_to_config_units = kix.Units.kix.Has((string[])(Session["privilege_array"]), "config-units");
            }
        ...
        {
            this.PreRender += this.TWebUserControl_unit_PreRender;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_units.Set(kix.Units.kix.Safe(TextBox_id.Text, kix.safe_hint_type.NUM), kix.Units.kix.Safe(TextBox_description.Text, kix.safe_hint_type.PUNCTUATED), kix.Units.kix.Safe(DropDownList_division.SelectedValue, kix.safe_hint_type.NUM));
        ...
        {
            if (p.biz_units.Delete(kix.Units.kix.Safe(TextBox_id.Text, kix.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
