...
type
  ...
  public
    ...
    function Privileges: string_array;
    function Roles: string_array;
  end;
...
function TClass_biz_user.Privileges: string_array;
begin
  Privileges := db_users.PrivilegesOf(IdNum);
end;

function TClass_biz_user.Roles: string_array;
begin
