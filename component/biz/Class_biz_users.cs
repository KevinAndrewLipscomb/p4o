  ...
  public class TClass_biz_users
    {
        ...
        {
            bool result;
            result = db_users.Get(username, out encoded_password, out be_stale_password, out password_reset_email_address, out be_active, out num_unsuccessful_login_attempts, out last_login);
