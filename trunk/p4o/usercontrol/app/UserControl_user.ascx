...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td valign="top">
      ...
      <ASP:DropDownList id="DropDownList_username" runat="server" visible="False" autopostback="True" onselectedindexchanged="DropDownList_username_SelectedIndexChanged"></ASP:DropDownList><br>
    </td>
    <td valign="top">
  ...
  <tr>
    ...
    <td>
      <ASP:TextBox id="TextBox_password_reset_email_address" runat="server" columns="60" maxlength="255" enabled="False"></ASP:TextBox>
    </td>
    <td>
