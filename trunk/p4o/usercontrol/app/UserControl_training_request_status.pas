...
procedure TWebUserControl_user.DropDownList_username_SelectedIndexChanged(sender: System.Object;
  e: System.EventArgs);
begin
  {$MESSAGE HINT 'Review safe-hint and tighten if necessary'}
PresentRecord(Safe(DropDownList_spec.selectedvalue,PUNCTUATED));
end;

procedure TWebUserControl_training_request_status.LinkButton_go_to_match_first_Click(sender: System.Object;
  e: System.EventArgs);
begin
  DropDownList_code.selectedindex := 1;
  {$MESSAGE HINT 'Review safe-hint and tighten if necessary'}
PresentRecord(Safe(DropDownList_code.selectedvalue,PUNCTUATED));
end;

procedure TWebUserControl_training_request_status.LinkButton_go_to_match_prior_Click(sender: System.Object;
  e: System.EventArgs);
begin
...
procedure TWebUserControl_training_request_status.LinkButton_go_to_match_next_Click(sender: System.Object;
  e: System.EventArgs);
begin
...
procedure TWebUserControl_training_request_status.LinkButton_go_to_match_last_Click(sender: System.Object;
  e: System.EventArgs);
begin
