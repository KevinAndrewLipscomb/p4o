    ...
    <td valign="top"><font class="">
      ...
      <table>
        <tr>
          ...
          <td>
            <div style="width:0px;white-space:nowrap;"><ASP:DropDownList id="DropDownList_registration_code" runat="server" visible="False" autopostback="True" onselectedindexchanged="DropDownList_registration_code_SelectedIndexChanged"></ASP:DropDownList></div>
          </td>
        </tr>
      </table>
    </font>
