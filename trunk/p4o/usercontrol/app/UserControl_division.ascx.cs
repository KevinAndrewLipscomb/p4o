    ...
    public partial class TWebUserControl_division: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            else
            {
                ...
                p.be_ok_to_config_divisions = kix.Units.kix.Has((string[])(Session["privilege_array"]), "config-divisions");
            }
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_divisions.Set(kix.Units.kix.Safe(TextBox_id.Text, kix.safe_hint_type.NUM), kix.Units.kix.Safe(TextBox_description.Text, kix.safe_hint_type.PUNCTUATED), kix.Units.kix.Safe(DropDownList_bureau.SelectedValue, kix.safe_hint_type.NUM));
        ...
        {
            if (p.biz_divisions.Delete(kix.Units.kix.Safe(TextBox_id.Text, kix.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
