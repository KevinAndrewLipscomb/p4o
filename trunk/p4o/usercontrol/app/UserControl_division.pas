...
begin
  ...
  //
  TextBox_description.enabled := p.be_ok_to_config_divisions;
  DropDownList_bureau.enabled := p.be_ok_to_config_divisions;
  //
...
procedure TWebUserControl_division.ManageDependentFieldEnablements;
begin
  TextBox_description.enabled := p.be_ok_to_config_divisions;
  DropDownList_bureau.enabled := p.be_ok_to_config_divisions;
end;
