<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_bureau.pas" Inherits="UserControl_bureau.TWebUserControl_bureau"%>
          ...
          <td valign="top">
            <font class="compact">
              ...
              <ASP:TextBox id="TextBox_id" runat="server" columns="3" maxlength="3" cssclass="compact"></ASP:TextBox><ASP:Button id="Button_lookup" runat="server" causesvalidation="False" text="LOOKUP"></ASP:Button>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False">Enter brand new Bureau</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
              </table>
