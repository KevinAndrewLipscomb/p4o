...
type
  ...
  public
    ...
    function Get
      ...
      out num_unsuccessful_login_attempts: cardinal;
    ...
    function PrivilegesOf(id: string): string_array;
...
function TClass_db_users.PrivilegesOf(id: string): string_array;
var
  dr: mysqldatareader;
  num_privileges: cardinal;
  privileges_of: string_array;
begin
  self.Open;
  dr := mysqlcommand.Create
    (
