                  ...
                  <table cellspacing="0" cellpadding="5" width="%" border="0">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <ASP:CompareValidator id="CompareValidator_confirmation_password" runat="server" font-bold="True" errormessage="Nominal and confirmation passwords must match.  Please try again." controltovalidate="TextBox_confirmation_password" controltocompare="TextBox_nominal_password">!ERR!</ASP:CompareValidator>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
